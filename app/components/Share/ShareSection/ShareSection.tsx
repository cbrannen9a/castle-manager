    ...
    <section className="m-4 h-8">
      <div className="m-auto max-w-xl">
        <div className="inline-flex w-full justify-center">
          <Share
            className="leading-sm inline-flex h-8 items-center rounded-full border bg-white px-3 py-1 text-xs font-bold uppercase text-gray-700 hover:bg-gray-200"
            shareData={shareData}
          >
            <span>{text}</span>
            <svg
              className="m-2 h-4 w-4 fill-current"
